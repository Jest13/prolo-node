...
#
# - Push new commits to prolo-project/guix from upstream. Do not forget to update
#   the keyring branch as well. Guix uses this branch to authenticate commits.
#
#   The repository is set to prolo-project/guix because fetching from the official
#   repo at https://git.savannah.gnu.org/git/guix.git is unreliable in CI jobs.
#
#   Do not attempt to push custom changes to prolo-project/guix, it will not work!
...
time-machine() {
    ...
    guix time-machine --url=https://github.com/prolo-project/guix.git \
