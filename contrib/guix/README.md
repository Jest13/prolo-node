# Bootstrappable Prolo Builds

This directory contains the files necessary to perform bootstrappable Prolo 
builds.
...
To build Prolo reproducibly with all default options, invoke the
...
repository](https://github.com/prolo-project/guix.sigs).
